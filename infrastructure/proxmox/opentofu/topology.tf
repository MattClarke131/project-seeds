  ...
  proxmox_hosts = [
    {
      ...
      control_plane = { ip_address = "10.0.10.30", mac_address = "BC:24:11:5A:34:D5", cores = 4, memory_mb = 4096, datastore_id = "local-zfs", disk_size_gb = 50, }
      workers = [
        { ip_address = "10.0.10.31", mac_address = "BC:24:11:64:EF:4D", cores = 4, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 50, },
        { ip_address = "10.0.10.32", mac_address = "BC:24:11:06:3E:03", cores = 4, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 50, },
      ]
    },
    {
      name = "livio", host_ip = "10.0.10.10", cores = 4, memory_mb = 32768, host_reserved_mb = 4096, template_vm_id = 20000,

      control_plane = { ip_address = "10.0.10.40", mac_address = "BC:24:11:B2:B0:8C", cores = 4, memory_mb = 4096, datastore_id = "local-zfs", disk_size_gb = 50, }
      workers = [
        ...
        { ip_address = "10.0.10.41", mac_address = "BC:24:11:0B:6D:B4", cores = 4, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 100, },
        { ip_address = "10.0.10.42", mac_address = "BC:24:11:5B:DE:D9", cores = 4, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 50, },
      ]
    },
    {
      ...
      control_plane = { ip_address = "10.0.10.50", mac_address = "BC:24:11:86:41:0C", cores = 8, memory_mb = 4096, datastore_id = "razlo-etcd", disk_size_gb = 50, }
      workers = [
        { ip_address = "10.0.10.51", mac_address = "BC:24:11:07:64:8A", cores = 8, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 50, },
        { ip_address = "10.0.10.52", mac_address = "BC:24:11:3E:CF:5B", cores = 8, memory_mb = 12288, datastore_id = "local-zfs", disk_size_gb = 50, },
      ]
    }
  ]
}
